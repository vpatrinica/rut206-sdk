...
static struct qti_8x8x_pinctrl_setting qti_8x8x_pin_settings[] = {
	...
	QTI_8X8X_PIN_SETTING_MUX(6,  QTI_8X8X_PIN_FUNC_P0_LED_2),
	QTI_8X8X_PIN_SETTING_MUX(7,  QTI_8X8X_PIN_FUNC_P1_LED_2),
	QTI_8X8X_PIN_SETTING_MUX(8,  QTI_8X8X_PIN_FUNC_P2_LED_2),
	QTI_8X8X_PIN_SETTING_MUX(9,  QTI_8X8X_PIN_FUNC_P3_LED_2),
...
static void qti_8x8x_led_hw_control(struct phy_device *phydev)
{
	u32 phy_addr;

	for (phy_addr = 0x1; phy_addr <= 0x4; phy_addr++) {

		qti_8x8x_phy_mmd_write(phydev, phy_addr,
				QTI_8X8X_PHY_MMD7_NUM,
				QTI_8X8X_PHY_LED_1, QTI_8X8X_PHY_2_5GB);

		qti_8x8x_phy_mmd_write(phydev, phy_addr,
				QTI_8X8X_PHY_MMD7_NUM,
				QTI_8X8X_PHY_LED_0, QTI_8X8X_PHY_1GB);

		qti_8x8x_phy_mmd_write(phydev, phy_addr,
				QTI_8X8X_PHY_MMD7_NUM,
				QTI_8X8X_PHY_LED_2, QTI_8X8X_PHY_ACT);
	}
}
		...
		struct qti_8x8x_switch_info * swt_info)
{
	...
	qti_8x8x_led_hw_control(phydev);
